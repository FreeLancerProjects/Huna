...
public class Fragment_Driver_Grocery_Previous_Order extends Fragment {
    ...
    private void iniView(View view) {
        ...
        adapter = new Driver_Grocery_Current_Previous_Order_Adapter(getActivity(),driver_grocery_orderModelList,this,"previous");
        recView.setAdapter(adapter);
        getData();
    }

    public static Fragment_Driver_Grocery_Previous_Order getInstance(String user_id)
    {
        Bundle bundle = new Bundle();
        bundle.putString(USER_ID,user_id);
        Fragment_Driver_Grocery_Previous_Order fragment = new Fragment_Driver_Grocery_Previous_Order();
    ...
    private void getData() {
        ...
        Api.getServices()
                .getDriver_Grocery_PreviousOrder(user_id)
