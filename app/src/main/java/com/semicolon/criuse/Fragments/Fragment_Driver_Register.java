...
public class Fragment_Driver_Register extends Fragment implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private EditText edt_name,edt_phone,edt_city,edt_neighborhood,edt_userName,edt_password,edt_re_password;
    ...
    private String m_name="",m_phone="",m_city="",m_neighborhood="",m_userName="",m_password="",m_rePassword;
    ...
    private void initView(View view) {
        ...
        edt_neighborhood = view.findViewById(R.id.edt_neighborhood);
    ...
    private void Register()
    {
        ...
        m_city = edt_city.getText().toString();
        m_neighborhood = edt_neighborhood.getText().toString();
        ...
        }else if (TextUtils.isEmpty(m_city))
        {
            edt_name.setError(null);
            edt_phone.setError(null);
            edt_city.setError(getString(R.string.city_req));
        }
        else if (TextUtils.isEmpty(m_neighborhood))
        {
            edt_name.setError(null);
            edt_phone.setError(null);
            edt_city.setError(null);
            edt_neighborhood.setError(getString(R.string.neighborhood_req));
        }
        else if (TextUtils.isEmpty(imagePath_2))
        {
            ...
            edt_phone.setError(null);
            edt_city.setError(null);
            edt_neighborhood.setError(null);
        ...
        }else
        {
            ...
            RequestBody userneighbourhoodPart = RequestBody.create(MediaType.parse("text/plain"),m_neighborhood);
            RequestBody userCityPart = RequestBody.create(MediaType.parse("text/plain"),m_city);
