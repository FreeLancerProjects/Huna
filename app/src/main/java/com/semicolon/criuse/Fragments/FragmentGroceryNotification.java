...
public class FragmentGroceryNotification extends Fragment{
    ...
    public static FragmentGroceryNotification getInstance(String user_type)
    {
        FragmentGroceryNotification fragment_setting = new FragmentGroceryNotification();
