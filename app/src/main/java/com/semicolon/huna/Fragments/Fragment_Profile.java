...
public class Fragment_Profile extends Fragment implements View.OnClickListener{
    ...
    private android.app.AlertDialog alertDialog_country,alertDialog_neighborhood;
    ...
    private void UpdateUi(UserModel userModel) {
        ...
        if (userModel!=null)
        {
            ...
            if (userModel.getUser_type().equals(Tags.user_type_driver))
            {
                ...
                tv_city.setText(userModel.getCity_title());
                tv_neighbourhood.setText(userModel.getArea_title());
                ...
                .enqueue(new Callback<List<CountryModel>>() {
                    ...
                    public void onResponse(Call<List<CountryModel>> call, Response<List<CountryModel>> response) {
                        ...
                        if (response.isSuccessful())
                        {
                            ...
                            Fragment_Profile.this.countryModelList = response.body();

                            CreateCountyAlertDialog(response.body());
                        }
                    }
    ...
    private void getCountryDataForNeighborhood() {
        progDialogCountry = Common.CreateProgressDialog(getActivity(),"Loading...");
        Api.getServices()
                .getCountries()
                .enqueue(new Callback<List<CountryModel>>() {
                    ...
                    public void onResponse(Call<List<CountryModel>> call, Response<List<CountryModel>> response) {
                        ...
                        if (response.isSuccessful())
                        {
                            ...
                            if (Fragment_Profile.this.countryModelList.size()>0)
                            {
                                for (CountryModel countryModel:countryModelList)
                                {
                                    if (countryModel.getCity_id().equals(userModel.getUser_city()))
                                    {
                                        neighborhoodList = countryModel.getSub_areas();
                                        CreateNeighborhoodAlertDialog(countryModel.getSub_areas(),"0");
                                    }
                                }
                            }

                            //CreateNeighborhoodAlertDialog();
                        }
                    }
    ...
    private void CreateCountyAlertDialog(List<CountryModel> countryModelList) {
        if (countryModelList.size()>0)
        {
            ...
            RecyclerView.Adapter adapter = new Country_Adapter(getActivity(),countryModelList,this,"fragment_profile");
            recView.setAdapter(adapter);

            alertDialog_country = new android.app.AlertDialog.Builder(getActivity())
                    .setCancelable(true)
                    .create();
    ...
    private void CreateNeighborhoodAlertDialog(List<CountryModel.Neighborhood> neighborhoodList,String alert_close) {
        if (countryModelList.size()>0)
        {
            ...
            RecyclerView.LayoutManager manager = new LinearLayoutManager(getActivity());
            recView.setLayoutManager(manager);
            RecyclerView.Adapter adapter = new Neighborhood_Adapter(getActivity(),neighborhoodList,this,"fragment_profile");
            recView.setAdapter(adapter);

            alertDialog_neighborhood = new android.app.AlertDialog.Builder(getActivity())
                    .create();

            if (alert_close.equals("1"))
            {
                alertDialog_neighborhood.setCancelable(false);
            }else
                {
                    alertDialog_neighborhood.setCancelable(true);
    ...
    public void setItem(CountryModel countryModel)
    {
        ...
        Update_City(city_id);
        CreateNeighborhoodAlertDialog(countryModel.getSub_areas(),"1");
    ...
    public void onClick(View view) {
        ...
        switch (id)
        {
            ...
            case R.id.image_edit_city:
                ...
                Log.e("sizzzzzzzzzzzze",countryModelList.size()+"___");
                if (countryModelList.size()>0)
                {
            ...
            case R.id.image_edit_neighbourhood:
                Log.e("sizzzzzzzzzzzze22",neighborhoodList.size()+"___");
...
*/
    ...
    private void Update_ImageProfile(File file)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.upd_img_prof));
    ...
    private void Update_Name(String name)
    {
        ...
        String type = userModel.getUser_type();
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.updating_name));
    ...
    private void Update_Phone(String phone)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.updating_phone));
    ...
    private void Update_userName(String user_name)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.updating_username));
    ...
    private void Update_Password(String old_password, String newpassword)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.updating_pass));
        progressDialog.show();
    ...
    private void Update_City(String city)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.updating_city));
    ...
    private void Update_Neighbourhood(String neighbourhood)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.updating_nei));
    ...
    private void Update_ImageLicense(File file)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.upd_licence_photo));
    ...
    private void Update_ImageResidence(File file)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.upd_resd_photo));
    ...
    private void Update_ImageCarForm(File file)
    {
        ...
        ProgressDialog progressDialog = Common.CreateProgressDialog(getActivity(),getString(R.string.upd_car_form));
