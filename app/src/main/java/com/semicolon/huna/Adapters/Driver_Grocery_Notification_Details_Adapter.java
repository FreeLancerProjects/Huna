...
public class Driver_Grocery_Notification_Details_Adapter extends RecyclerView.Adapter<Driver_Grocery_Notification_Details_Adapter.MyHolder> {

    private Context context;
    private List<Driver_Grocery_Notification_Model.Bill_Product> bill_productList;

    public Driver_Grocery_Notification_Details_Adapter(Context context, List<Driver_Grocery_Notification_Model.Bill_Product> bill_productList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        Driver_Grocery_Notification_Model.Bill_Product bill_product = bill_productList.get(position);
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public void BindData(Driver_Grocery_Notification_Model.Bill_Product bill_product)
        {
