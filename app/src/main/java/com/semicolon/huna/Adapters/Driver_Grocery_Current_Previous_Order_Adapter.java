...
import com.semicolon.huna.Fragments.Fragment_Driver_Grocery_Current_Order;
import com.semicolon.huna.Fragments.Fragment_Driver_Grocery_Previous_Order;
                ...
                btn_delivered.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        {        Log.e("ssssss","1444");
                            ...
                            Driver_Grocery_OrderModel driver_grocery_orderModel = driver_grocery_orderModelList.get(getAdapterPosition());
                            if (order_state.equals("current"))
                            {
                                Log.e("ssssss","1333");

                                fragment1.EndOrder(driver_grocery_orderModel,getAdapterPosition());
                            }
                        }
                    }
                });
