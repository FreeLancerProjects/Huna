...
import com.semicolon.huna.Fragments.Fragment_Client_Current_Order;
import com.semicolon.huna.Fragments.Fragment_Client_Previous_Order;
            ...
            if (order_state.equals("current"))
            {
                ...
                btn_delivered.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (clientOrderModelList.size()>0)
                        {
                            ClientOrderModel  clientOrderModel = clientOrderModelList.get(getAdapterPosition());
                            if (order_state.equals("current"))
                            {
                                fragment1.EndOrder(clientOrderModel,getAdapterPosition());
                            }
                        }
                    }
                });
