...
public class Client_Order_Details_Adapter extends RecyclerView.Adapter<Client_Order_Details_Adapter.MyHolder> {

    private Context context;
    private List<ClientOrderModel.Bill_Product> bill_productList;

    public Client_Order_Details_Adapter(Context context, List<ClientOrderModel.Bill_Product> bill_productList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ClientOrderModel.Bill_Product bill_product = bill_productList.get(position);
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        public void BindData(ClientOrderModel.Bill_Product bill_product)
        {
